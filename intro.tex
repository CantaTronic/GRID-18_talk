...
\begin{frame}{Astroparticle data life cycle features}
%  \vspace{-1em}
% \textcolor{red!50!black}{Change the collboration picture}
% \vspace{-1ex}
% \centering
...
\begin{itemize}
\setlength{\itemsep}{0pt}
\item<2-> Experiments improve and are measuring events with greater precision (large amount of data);
% \item<3-> But we cannot control the number of incoming particles;
\item<3-> But not too many events of our interest;
\item[]<4-> $\Rightarrow$ combined analysis of data from different experiments becomes topical;
% \item Data life cycle needs to be developed;
\item<5-> Astronomical Virtual Observatories (Auger \& IceCube data).
\end{itemize}
