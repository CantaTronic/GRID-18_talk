...
\begin{columns}
  \begin{column}[t]{0.45\textwidth}
    \begin{figure}[h]
    \vspace{-1em}
    \center{\includegraphics[width=0.79\linewidth]{pics/appec_base4.png}}
    \hspace{-1em}
    \vspace{-1em}
...
\vspace{-1em     }
    \begin{figure}[h]
    \center{\includegraphics[width=0.9\linewidth]{pics/Collab.png}}
...
\begin{frame}{KASCADE}
    \begin{figure}[h]
%     \vspace{-1em}
    \center{\includegraphics[width=0.79\linewidth]{pics/timeline_kascade.png}}
%     \hspace{-1em}
%     \vspace{-1em}
