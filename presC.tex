...
\begin{frame}{References}
  \begin{itemize}
   ...
   web-source:~\texttt{appec.org/wp-content/uploads/Documents/Docs-from-old-site/AModelForComputing-2.pdf}
   \item KCDC - \textbf{K}ASCADE \textbf{C}osmic Ray \textbf{D}ata \textbf{C}enter,\\
   web-source:~\texttt{http://kcdc.ikp.kit.edu} 
   \item KASCADE-Grande official site, web-source:~\texttt{www-ik.fzk.de/KASCADE\_home.html};
   \item TAIGA collaboration official site, web-source:~\texttt{taiga-experiment.info};
   \item Astroparticle.online - outreach resource, web-source:~\texttt{astroparticle.online}.
